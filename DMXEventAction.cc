  ...
  if(S_hits) {
    ...
    */
	...
	//vertz=pv->GetZ0();
      ...
      //
      //G4double sigmaE = 2;//sigmaE=(4.298+0.00077*(edep*1000))/2.355; //multiplied by 1000 to have it in keV
      G4double sigmaE = 0.00712021*(edep*1000)/(2*sqrt(2*0.6931));
      G4double uGauss = G4RandGauss::shoot(edep*1000,sigmaE); //multiplied by 1000 to have it in keV
	...
	//G4cout << edep << G4endl;
	man->FillNtupleDColumn(1,6,uGauss);//change for a value in Gauss dist
